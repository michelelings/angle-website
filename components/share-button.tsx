...
export function ShareButton({ id }: { id: string }) {
  ...
  }}><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M12 15V3m-4 4 4-4 4 4M5 12v9h14v-9" /></svg><span className="episode-action-label">Share</span></button><p role="status" className="text-secondary text-sm mt-2 break-all">{status}</p></>;
}
