import { artworkVariantUrl } from '@/lib/artwork';
...
export default async function Stream() {
  ...
  return <main><ArtworkThemeSource src={episodes[0]?.coverImage ? artworkVariantUrl(episodes[0], 'small') : '/images/icon.webp'} /><Header count={episodes.length} stream /><div className="rails-container">
